...
<div class="alert alert-error">
<a class="close" href="javascript:history.go(-1);">&times;</a>
掲示板の設定に失敗しました。<br/>エラー内容 : <?php echo $error;?><br/><br/>
...
<a class="close" href="javascript:history.go(-1);">&times;</a>
<?php echo $ncid; ?> 掲示板の設定を変更しました。<br/><br/>
<a class="btn btn-success" href="admin.php?cAct=adminBoardSetup&cid=<?php echo $ncid; ?>">完了</a>
</div>
<?php
}
?>
