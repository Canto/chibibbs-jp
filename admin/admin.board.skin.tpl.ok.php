...
<div class="alert alert-error">
<a class="close" href="javascript:history.go(-1);">&times;</a>
掲示板テンプレート保存に失敗しました。<br/>詳細 : <?php echo $error;?><br/><br/>
<a class="btn btn-danger" href="javascript:history.go(-1);">もどる</a>
</div>
<?php
...
<a class="close" href="javascript:history.go(-1);">&times;</a>
<?php echo $cid; ?> 掲示板テンプレートを保存しました。<br/><br/>
<a class="btn btn-success" href="admin.php?cAct=adminSkinTpl&cid=<?php echo $cid; ?>&skin=<?php echo $skin; ?>">完了</a>
</div>
<?php
}
?>
