...
ログイン状態ではありません。<br/>
ログリンしてください。<br/><br/>
<a class="btn btn-danger" href="../login.php?mode=admin">ログインページへ</a>
</div>
</div>
<?php
}else{
...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		...
		<a href="admin.php" class="brand logo"><strong>Chibi Tool BBS 管理者ページ</strong></a>
			...
			?>
              <li class="<?php if($cAct=="adminBoardCreate") echo "active";?>">
                <a href="?cAct=adminBoardCreate" >掲示板作成</a>
              </li>
			  <li class="<?php if($cAct=="adminMemberList") echo "active";?>">
                <a href="?cAct=adminMemberList" >会員管理</a>
              </li>
			 <?php
			}
			?>
			  <li class="<?php if($cAct=="adminBoardList"||$cAct=="adminBoardSetup"||$cAct=="adminBoardReset"||$cAct=="adminBoardDelete") echo "active";?>">
                <a href="?cAct=adminBoardList" >掲示板管理</a>
              </li>
			  <li class="">
                <a href="../logout.php?user_id=<?php echo $member->user_id;?>" >ログアウト</a>
              </li>
			  <?php
				if($member->permission=="super"){
			  ?>
		      <li class="">
                <a id="uninstall" href="javascript:;" >アンインストール</a>
              </li>
			  <?php
			}
			  ?>
