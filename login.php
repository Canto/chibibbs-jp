...
<title>Chibi Tool BBS ログイン</title>
<style type="text/css">
...
<td>
<div class="control-group">
	<label class="control-label" for="passwd">パースワード</label>
	<div class="controls">
		<input type="password" id="passwd" name="passwd" placeholder="パースワード" required>
	</div>
</div>
</td>
</tr>
...
<td>
	...
	<div class="control-group">
		<div class="controls from-actions">
			...
			<a class="btn" href="javascript:history.go(-1);">もどる</a>
		</div>
	</div>
</td>
</tr>
